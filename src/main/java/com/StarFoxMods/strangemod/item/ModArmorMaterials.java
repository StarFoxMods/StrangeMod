...
public enum ModArmorMaterials implements ArmorMaterial {
    STRANGE_MATERIAL("strange_material", 39, new int[]{4, 7, 9, 4}, 22, SoundEvents.ARMOR_EQUIP_NETHERITE,
            5.0F, 0.5F, () -> Ingredient.of(ModItems.STRANGE_MATERIAL.get()));
    ...
    public String getName() {
        return StrangeMod.MOD_ID + ":" + this.name;
    }
